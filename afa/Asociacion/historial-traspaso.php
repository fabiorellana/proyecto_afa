 ...
 dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><div class="fa fa-user-circle">&nbsp;</div>Sesión <i class="fa fa-caret-down"></i></a>
        ...
        <div class="section">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 align="center">Historial de Traspasos</h1>
                    </div>
                </div>
            </div>
        </div>
          ...
          <div class="container">
                <div class="row">
                    <div class="col-md-12">
                      ...
                      <table width="100%" border="0" class="table table-condensed table-responsive table-bordered">
  <tr>
    <th scope="col">Nombre del jugador</th>
    <th scope="col">Club original</th>
    <th scope="col">Club actual</th>
					  ...
					  $sql="SELECT club.nombre as solicita, traspaso.id_club_destino , traspaso.estado, jugadores.nombre from traspaso inner join club INNER join jugadores where traspaso.id_club_solicitante=club.id and traspaso.estado=3 and traspaso.ID_jugador=jugadores.rut";
    ...
    <th scope="col"><?php echo $row['nombre'];?></th>
     <th scope="col"><?php echo $row['id_club_destino']; ?></th>
      <th scope="col"><?php echo $row['solicita']?></th>
