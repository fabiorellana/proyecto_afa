                    ...
                    <div class="col-md-12">
                        <form class="form-horizontal" action="" method="post" role="form">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
 <input type="text" class="form-control" placeholder="Rut a validar, ej: 11111111"  id="txtrutT"  maxlength="8"   name="txtrutT" required>      
    </div>     
      <div class="col-xs-1"> <input type="text" class="form-control "  id="txtvalidador"   name="txtvalidador"  placeholder="1" maxlength="1" required></div>
       <div id="destino"> </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" maxlength="100" name="txtNombresT" id="txtNombresT" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" maxlength="100" name="txtApellidosT" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" maxlength="100" name="txtDireccionT" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" maxlength="11" name="txtTelefonoT" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-10">
                                    <input type="email" class="form-control" name="txtEmailT" maxlength="100" placeholder="correo@example.cl" required>
                                </div>
                            </div>
                            <br>
                            <br>
