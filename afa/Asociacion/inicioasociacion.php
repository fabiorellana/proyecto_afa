			 ...
			 <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
               <li>
                  ...
                  <li>
                  <a href="admincomite.php"><div class="fa fa-user-secret">&nbsp;</div>Administrar Comite </a>
                </li>
              </ul>
            </li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            ...
            $cnn = Conectar(); 
$sql="select nombre from club where id='".$idusuario."'";
...
while($rows=mysql_fetch_array($resul)){
			...
			?>
			Bienvenido Sr.  <?php echo " &nbsp; ",$rows['nombre'];}?></h4>
                    <img src="Archivos\Imagenes\logo afa\soccer-player-silhouettes_9625900.png"
                    class="img-responsive">
                  </div>
				 
                  <div class="col-md-7"> <p>Lorem ipsum dolor sit amet, consectetur adipisici elit,
