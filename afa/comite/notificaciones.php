...
<html><head>
 ...
 dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><div class="fa fa-user-circle">&nbsp;</div>Sesión <i class="fa fa-caret-down"></i></a>
     ...
     <?php $sql="select count(estado) as estado from informe where estado = 1";
		...
		if($sum>=1){		echo "<div class='section'>
      <div class='container'><div class='row'><div class='col-md-12'><div class='alert alert-dismissable alert-success'><font color='white'><h5><a href='informes.php'><strong>¡Atención!</strong> Tienes " .$sum. " informes de Partidos sin revisar</font></a></h5></div></div></div></div>
    </div>";}
				}
