...
<head>
<title>Administrar Comite</title>
<script src="https://use.fontawesome.com/d0c885a572.js"></script>
 ...
 dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><div class="fa fa-user-circle">&nbsp;</div>Sesión <i class="fa fa-caret-down"></i></a>
        ...
        <div class="row">
         <div class="col-md-12"> 
         <h1 class="text-center">Buscar Comite</h1> 
         </div>
         </div>
         <div class="row">
          ...
          <div class="input-group">
           <input type="text" class="form-control" placeholder="Buscar comite" id="buscarcomite"><!--Input para buscar comite--> 
           <span class="input-group-btn">
            ...
            <div class="container" id="tablacomite"></div><!--Container para mostrar los datos del comite-->
